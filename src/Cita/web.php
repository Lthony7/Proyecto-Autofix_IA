...
Route::middleware('auth')->group(function () {
    ...
    Route::get('citas/{cita}/disponibilidad', [CitaWebController::class, 'disponibilidadReprogramacion'])->name('citas.disponibilidad')->middleware('permission:citas.gestionar');
