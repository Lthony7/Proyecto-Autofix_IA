...
Route::middleware('auth')->group(function () {
    ...
    Route::get('reportes/ingresos', [ReporteWebController::class, 'index'])->defaults('vista', 'ingresos')->name('reportes.ingresos')->middleware('permission:reportes.financieros');
    ...
    Route::get('reportes/exportar', [ReporteWebController::class, 'exportar'])
        ->name('reportes.exportar')->middleware('permission:reportes.exportar');
});
